    ...
    <div>
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex justify-between items-center">
                <h2 class="text-2xl font-bold mb-4 text-primary">Daftar Tag</h2>
                <Link :href="route('admin.tags.create')" class="bg-primary text-white px-4 py-1">
                    Add Tag
                </Link>
            </div>
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <tr v-for="tag in tags" :key="tag.id">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-primary font-semibold">{{ tag.name }}</td>
                        ...
                        <td>
                            <div class="flex gap-2">
                                ...
                                <button @click="router.delete(route('admin.tags.destroy', tag.slug), {
                                    preserveScroll: true
                                })">
