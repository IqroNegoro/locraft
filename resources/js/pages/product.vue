                        ...
                        <form @submit.prevent="form.post(route('products.review', product.slug), {
                            ...
                            <div class="flex flex-col gap-6">
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <div ref="reviewInput" contenteditable :class="{
                                        'border border-red-500': form.review!.length > 5000 || form.errors?.review,
                                        'w-full min-h-24 py-1 inline-block border border-gray-200 focus:border-primary rounded-xl p-3': true
                ...
                <div class="lg:col-span-1">
                    <div class="bg-white border border-gray-200 rounded-2xl p-8 h-fit sticky top-8 shadow-lg">
                        ...
                        <div class="flex items-start gap-5 mb-6">
                            <div class="relative">
                                <img :src="product.user.avatar" alt="Sarah Chen"
